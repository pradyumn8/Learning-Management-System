                ...
                ${showControls ? 'opacity-100' : 'opacity-0'}`}>
                    ...
                    <div className='flex items-center justify-between'>
                        <div className='flex items-center space-x-2'>
                            <Button varient="ghost" size="icon" onClick={handlePlayAndPause}
                                className="text-white bg-transparent hover:text-white hover:bg-gray-700">
                                {
                                    playing ? <Pause className="h-6 w-6" /> : <Play />
                                }
                            </Button>
                            <Button onClick={handleRewind} varient="ghost" size="icon"
                                className="text-white bg-transparent hover:text-white hover:bg-gray-700">
                                <RotateCcw className='h-6 w-6' />
                            </Button>
                            <Button onClick={handleForword} varient="ghost" size="icon"
                                className="text-white bg-transparent hover:text-white hover:bg-gray-700">
                                <RotateCw className='h-6 w-6' />
                            </Button>
                            <Button onClick={handleToggleMute} varient="ghost" size="icon"
                                className="text-white bg-transparent hover:text-white hover:bg-gray-700">
                                {
                                    muted ? (
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <Button 
                            onClick={handleFullScreen} varient="ghost" size="icon"
                            className="text-white bg-transparent hover:text-white hover:bg-gray-700">
                                {
